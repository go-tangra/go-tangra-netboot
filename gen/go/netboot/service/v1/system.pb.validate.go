...
// Validate checks the field values on CheckUpstreamResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CheckUpstreamResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CheckUpstreamResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CheckUpstreamResponseMultiError, or nil if none found.
func (m *CheckUpstreamResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CheckUpstreamResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CheckUpstreamResponseMultiError(errors)
	}

	return nil
}

// CheckUpstreamResponseMultiError is an error wrapping multiple validation
// errors returned by CheckUpstreamResponse.ValidateAll() if the designated
// constraints aren't met.
type CheckUpstreamResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CheckUpstreamResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CheckUpstreamResponseMultiError) AllErrors() []error { return m }

// CheckUpstreamResponseValidationError is the validation error returned by
// CheckUpstreamResponse.Validate if the designated constraints aren't met.
type CheckUpstreamResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CheckUpstreamResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CheckUpstreamResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CheckUpstreamResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CheckUpstreamResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CheckUpstreamResponseValidationError) ErrorName() string {
	return "CheckUpstreamResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CheckUpstreamResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCheckUpstreamResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CheckUpstreamResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CheckUpstreamResponseValidationError{}
...
func (m *GetStatsResponse) validate(all bool) error {
	...
	// no validation rules for TotalMachines

	// no validation rules for InstallingMachines

	// no validation rules for InstalledMachines

	// no validation rules for FailedMachines

	// no validation rules for TotalProfiles

	// no validation rules for ActiveSessions

	// no validation rules for UnknownBoots

	// no validation rules for ActiveLeases
