...
/**
 * Mounts a federated module into the running shell.
 *
 * Existing routes at the same paths are removed first so that a hot reload -
 * or a second registration after the remote is re-fetched - replaces the old
 * components instead of leaving two matching records behind.
 */
